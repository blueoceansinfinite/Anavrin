...
<head>
    ...
    <title>Aanya Pandith's Fitness Journey</title>
...
<body>
    ...
    <header>
        <div class="container">
            <h1>Aanya Pandith's Fitness Journey</h1>
            <p>A decade of dedication, resilience, and transformation through fitness and wellness.</p>
        </div>
    </header>
